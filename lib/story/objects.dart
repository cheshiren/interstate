...
GameObject ta = GameObject(
  ...
  description: [
    ...
    () {
      if (currentScene.id == 'road1' || currentScene.id == 'road2' || currentScene.id == 'insideTA') {
      ...
      'text': () {
        if (bottles.hidden) {
          ...
          if (objects.contains(mj)) {
            _temp = 'Воду убираю назад, а пакет с травкой кладу на пассажирское сиденье, рядом с урной.';
          } else {
            _temp = 'Последнюю бутылку воды кладу на пассажирское сиденье, рядом с урной.';
          }
